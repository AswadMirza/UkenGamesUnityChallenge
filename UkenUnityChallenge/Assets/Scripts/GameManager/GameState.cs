...
public class GameState : AState
{
    ...
    /*Changing the max lives to 5 causes an error for what i assume is because we are trying to access
     * images of hearts that actually arent present (The heart images are preloaded)
     * So if you want to change the number of hearts you have to add/subtract the heart images in the ui
     * If you want the GAMEPLAY to be affected you have to edit the public value attached to the Character input controller script
     * which is attached to the PlayerPivot object in the hierarchy
     */
    ...
    protected void UpdateUI()
    {
        ...
        //Also need to change this value here, its better to change this to max lives rather then a hard coded value like 3
		for (int i = 0; i < k_MaxLives; ++i)
		{
